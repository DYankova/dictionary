...
public class Runner {
	...
	public static void main(String[] args) {
		...
		// here I am creating my own ArrayList, named words, using its
		// constructor
		...
		// I am using the equals and hashCode to compare words and at the same
		// time I am printing it
		...
		Scanner in = new Scanner(System.in);// for scanning a system in the
											// console
		// while true= until this is true, endless repeat.Operator
		while (true) {
			System.out.println("enter Word:");
			String wordToFind = in.nextLine();// methods are calling with ()
			System.out.println(dict.find(wordToFind));// when I write down a
														// word from the
														// Dictionary on the
														// CONSOLE,it will
														// appears
